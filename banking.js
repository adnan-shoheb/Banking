...
function updateTransaction()
{
    ...
    var showopt = selectWD.options[showWD].value //you can even make use of .text instead of .value with necessary changes in html
    ...
    if(enterAmt>50000){
        alert("YOur are not suppose enter amount more than 50000")
    }
